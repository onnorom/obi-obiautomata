...
describe 'obijiautomata::service::linux::gatekeeper', :type => 'define' do
  #before(:each) do 
  ...
  on_supported_os.each do |os, facts|
    if os == 'Windows'
      ...
      context "on #{os}" do
        let(:title) { 'obijiautomata::service::linux::gatekeeper' } # sets title of the class declaration
        ...
        let(:params) { {
	  :ctrldir => facts['ctrldir'],
	  :servicetype => 'service',
        } }

	#it { should contain_obijiautomata::service::linux::gatekeeper }
	#it { is_expected.to contain_define('obijiautomata::service::linux::gatekeeper') }
